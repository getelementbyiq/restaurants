    ...
    >
      ...
      >
        ...
        >
          ...
          >
            der Gastronomie Branche ist nicht eine einfache Sache, wenn man nie
            selbst Kaffee serviert hatte.
          </Typography>
          <Typography
            sx={{
              fontFamily: "Noto Sans",
      ...
      <Grid container sx={{ display: "flex", border: "1px solid red" }}>
        <Grid
          item
          xs={5}
          md={5}
        ...
        >
          ...
          >
            Kostenlose Account, kostenlose online Menu
          </Typography>
          <Box sx={{ flexgrow: "1" }}></Box>
          <Button onClick={() => goTo("/signup")}>
            <Typography>ich bin ein Gastronom</Typography>
          </Button>
